let smlv=parseFloat(prompt("Ingrese salario mínimo legal vigente año 2022"));
 let subtte=parseFloat(prompt("Ingrese subsidio transporte año 2022"));
        function liquidar(){
            //SUELDO BÁSICO
            let n1=document.getElementById("salario").value;//bajar info salario de formulario
            let n2=document.getElementById("dias").value;//bajar info dias lab. del folmulario
